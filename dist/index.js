...
var Ni = (a, e, t) => e in a ? Vi(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[e] = t;
var C = (a, e, t) => Ni(a, typeof e != "symbol" ? e + "" : e, t), tt = (a, e, t) => e.has(a) || Jt("Cannot " + t);
var b = (a, e, t) => (tt(a, e, "read from private field"), t ? t.call(a) : e.get(a)), O = (a, e, t) => e.has(a) ? Jt("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(a) : e.set(a, t), T = (a, e, t, i) => (tt(a, e, "write to private field"), i ? i.call(a, t) : e.set(a, t), t), A = (a, e, t) => (tt(a, e, "access private method"), t);
import { isRef as ci, unref as Pe, hasInjectionContext as Wi, inject as fi, getCurrentScope as ji, computed as Ae, shallowReactive as Gi, reactive as Ui, watch as ye, onScopeDispose as Xi, shallowReadonly as Ji, readonly as qi, toRefs as Ki, defineComponent as $i, ref as Je, nextTick as Yi, onBeforeUnmount as Qi, resolveComponent as Zi, createElementBlock as $, openBlock as q, createElementVNode as j, createCommentVNode as it, Fragment as es, renderList as ts, normalizeClass as is, toDisplayString as Ce, createTextVNode as qt, createBlock as ss, withCtx as ns } from "vue";
class B {
  constructor(e) {
    this.table = e;
  }
...
class F {
  ...
  static deepClone(e, t, i = []) {
    ...
    for (var r in e) {
      let o = e[r], l, h;
      o != null && typeof o == "object" && (o.__proto__ === s || o.__proto__ === n) && (l = i.findIndex((d) => d.subject === o), l > -1 ? t[r] = i[l].copy : (h = Object.assign(Array.isArray(o) ? [] : {}, o), i.unshift({ subject: o, copy: h }), t[r] = this.deepClone(o, h, i)));
    }
    return t;
  }
}
let rs = class pi extends B {
  constructor(e, t, i) {
...
const Re = class Re extends R {
  ...
  transformRow(e, t) {
    ...
    return this.table.columnManager.traverse(function(r) {
      var o, l, h, d;
      r.modules.accessor && (l = r.modules.accessor[i] || r.modules.accessor.accessor || !1, l && (o = r.getFieldValue(n), o != "undefined" && (d = r.getComponent(), h = typeof l.params == "function" ? l.params(o, n, t, d, s) : l.params, r.setFieldValue(n, l.accessor(o, n, t, h, d, s)))));
    }), n;
  }
};
C(Re, "moduleName", "accessor"), //load defaults
C(Re, "accessors", os);
let rt = Re;
var as = {
  method: "GET"
...
function mi(a, e, t) {
  return a && t && Object.keys(t).length && (!e.method || e.method.toLowerCase() == "get") && (e.method = "get", a += (a.includes("?") ? "&" : "?") + ls(t)), a;
}
function hs(a, e, t) {
  var i;
...
const X = class X extends R {
  ...
  setDefaultConfig(e = {}) {
    this.config = Object.assign({}, X.defaultConfig), typeof e == "string" ? this.config.method = e : Object.assign(this.config, e);
  }
  //load config object
  generateConfig(e = {}) {
...
C(X, "moduleName", "ajax"), //load defaults
C(X, "defaultConfig", as), C(X, "defaultURLGenerator", mi), C(X, "defaultLoaderPromise", hs), C(X, "contentTypeFormatters", ds);
let lt = X;
var us = {
  replace: function(a) {
...
C(ee, "moduleName", "clipboard"), C(ee, "moduleExtensions", ms), //load defaults
C(ee, "pasteActions", us), C(ee, "pasteParsers", cs);
let ht = ee;
class gs {
  constructor(e) {
...
const te = class te extends R {
  ...
  generateRow(e, t) {
    ...
    return this.table.modExists("mutator") && this.table.modules.mutator.disable(), s = new I(i, this, "calc"), this.table.modExists("mutator") && this.table.modules.mutator.enable(), s.getElement().classList.add("tabulator-calcs", "tabulator-calcs-" + e), s.component = !1, s.getComponent = () => (s.component || (s.component = new gs(s)), s.component), s.generateCells = () => {
      var n = [];
  ...
  generateRowData(e, t) {
    ...
    return s.forEach(function(l) {
      ...
      }), o = n + "Params", r = typeof l.modules.columnCalcs[o] == "function" ? l.modules.columnCalcs[o](h, t) : l.modules.columnCalcs[o], l.setFieldValue(i, l.modules.columnCalcs[n](h, t, r)));
    }), i;
  }
  hasTopCalcs() {
...
C(te, "moduleName", "columnCalcs"), //load defaults
C(te, "calculations", bs);
let dt = te;
class wi extends R {
  constructor(e) {
...
function Cs(a, e = {}, t) {
  var i = [], s = [], n = {}, r = e.rowGroupStyles || {
    ...
    cellPadding: 4,
    fillColor: 232
  }, l = e.jsPDF || {}, h = e.title ? e.title : "", d, u;
  l.orientation || (l.orientation = e.orientation || "landscape"), l.unit || (l.unit = "pt"), a.forEach((f) => {
    switch (f.type) {
      case "header":
        i.push(c(f));
        break;
  ...
  d = this.dependencyRegistry.lookup("jspdf", "jsPDF"), u = new d(l), e.autoTable && (typeof e.autoTable == "function" ? n = e.autoTable(u) || {} : n = e.autoTable), h && (n.didDrawPage = function(f) {
    u.text(h, 40, 30);
  }), n.head = i, n.body = s, u.autoTable(n), e.documentProcessing && e.documentProcessing(u), t(u.output("arraybuffer"), "application/pdf");
}
function ys(a, e, t) {
  var i = this, s = e.sheetName || "Sheet1", n = this.dependencyRegistry.lookup("XLSX"), r = n.utils.book_new(), o = new B(this), l = "compress" in e ? e.compress : !0, h = e.writeOptions || { bookType: "xlsx", bookSST: !0, compression: l }, d;
  h.type = "binary", r.SheetNames = [], r.Sheets = {};
  function u() {
    var p = [], m = [], v = {}, g = { s: { c: 0, r: 0 }, e: { c: a[0] ? a[0].columns.reduce((E, L) => E + (L && L.width ? L.width : 1), 0) : 0, r: a.length } };
    return a.forEach((E, L) => {
      var H = [];
      E.columns.forEach(function(S, _) {
        S ? (H.push(!(S.value instanceof Date) && typeof S.value == "object" ? JSON.stringify(S.value) : S.value), (S.width > 1 || S.height > -1) && (S.height > 1 || S.width > 1) && m.push({ s: { r: L, c: _ }, e: { r: L + S.height - 1, c: _ + S.width - 1 } })) : H.push("");
      }), p.push(H);
...
const xe = class xe extends R {
  ...
  download(e, t, i, s, n) {
    ...
    if (typeof e == "function" ? r = e : xe.downloaders[e] ? r = xe.downloaders[e] : console.warn("Download Error - No such download type found: ", e), r) {
      ...
      r.call(this.table, l, i || {}, o.bind(this));
    }
  }
...
C(xe, "moduleName", "download"), //load defaults
C(xe, "downloaders", xs);
let ut = xe;
function Ze(a, e) {
  ...
  function r(o) {
    var l = t[o];
    typeof l < "u" && l !== n && l !== i && l !== s && (a.value = a.value + "" + l, r(o + 1));
  }
  a.addEventListener("keydown", (o) => {
    var l = a.value.length, h = o.key;
...
function Ts(a, e, t, i, s) {
  ...
  return r.addEventListener("change", o), r.addEventListener("blur", o), r.addEventListener("keydown", function(l) {
    switch (l.keyCode) {
      case 13:
        o();
        break;
...
function ks(a, e, t, i, s) {
  var n = a.getValue(), r = s.verticalNavigation || "hybrid", o = String(n !== null && typeof n < "u" ? n : ""), l = document.createElement("textarea"), h = 0;
  ...
  l.value = o, e(function() {
    a.getType() === "cell" && (l.focus({ preventScroll: !0 }), l.style.height = "100%", l.scrollHeight, l.style.height = l.scrollHeight + "px", a.getRow().normalizeHeight(), s.selectContents && l.select());
  });
  function d(u) {
  ...
  return l.addEventListener("change", d), l.addEventListener("blur", d), l.addEventListener("keyup", function() {
    ...
    l.style.height = u + "px", u != h && (h = u, a.getRow().normalizeHeight());
    ...
    switch (u.keyCode) {
      ...
      case 27:
        ...
        break;
      case 38:
        (r == "editor" || r == "hybrid" && l.selectionStart) && (u.stopImmediatePropagation(), u.stopPropagation());
        break;
      case 40:
        (r == "editor" || r == "hybrid" && l.selectionStart !== l.value.length) && (u.stopImmediatePropagation(), u.stopPropagation());
        break;
      case 35:
      case 36:
        u.stopPropagation();
...
function Ms(a, e, t, i, s) {
  ...
  e(function() {
    a.getType() === "cell" && (o.removeEventListener("blur", l), o.focus({ preventScroll: !0 }), o.style.height = "100%", o.addEventListener("blur", l), s.selectContents && o.select());
  });
  function h() {
    var d = o.value;
...
function Ss(a, e, t, i, s) {
  var n = s.format, r = s.verticalNavigation || "editor", o = n ? window.DateTime || luxon.DateTime : null, l = a.getValue(), h = document.createElement("input");
  function d(c) {
    var f;
...
function Ds(a, e, t, i, s) {
  var n = s.format, r = s.verticalNavigation || "editor", o = n ? window.DateTime || luxon.DateTime : null, l, h = a.getValue(), d = document.createElement("input");
...
function zs(a, e, t, i, s) {
  var n = s.format, r = s.verticalNavigation || "editor", o = n ? this.table.dependencyRegistry.lookup(["luxon", "DateTime"], "DateTime") : null, l, h = a.getValue(), d = document.createElement("input");
...
let Fs = class {
  ...
  _defaultSortFunction(e, t) {
    var i, s, n, r, o = 0, l, h = /(\d+)|(\D+)/g, d = /\d/, u = 0;
...
function Os(a, e, t, i, s) {
  ...
  for (var v = 1; v <= l; v++)
    p(v);
  return o = Math.min(parseInt(o), l), f(o), u.addEventListener("mousemove", function(g) {
    f(0);
...
function Ps(a, e, t, i, s) {
  var n = a.getElement(), r = typeof s.max > "u" ? n.getElementsByTagName("div")[0] && n.getElementsByTagName("div")[0].getAttribute("max") || 100 : s.max, o = typeof s.min > "u" ? n.getElementsByTagName("div")[0] && n.getElementsByTagName("div")[0].getAttribute("min") || 0 : s.min, l = (r - o) / 100, h = a.getValue() || 0, d = document.createElement("div"), u = document.createElement("div"), c, f;
  function p() {
    var m = window.getComputedStyle(n, null), v = l * Math.round(u.offsetWidth / ((n.clientWidth - parseInt(m.getPropertyValue("padding-left")) - parseInt(m.getPropertyValue("padding-right"))) / 100)) + o;
  ...
  return n.style.padding = "4px 4px", h = Math.min(parseFloat(h), r), h = Math.max(parseFloat(h), o), h = Math.round((h - o) / l), u.style.width = h + "%", n.setAttribute("aria-valuemin", o), n.setAttribute("aria-valuemax", r), u.appendChild(d), d.addEventListener("mousedown", function(m) {
    ...
    switch (m.keyCode) {
      case 39:
        m.preventDefault(), u.style.width = u.clientWidth + n.clientWidth / 100 + "px";
        break;
      case 37:
        m.preventDefault(), u.style.width = u.clientWidth - n.clientWidth / 100 + "px";
        break;
...
function As(a, e, t, i, s) {
  var n = a.getValue(), r = document.createElement("input"), o = s.tristate, l = typeof s.indeterminateValue > "u" ? null : s.indeterminateValue, h = !1, d = Object.keys(s).includes("trueValue"), u = Object.keys(s).includes("falseValue");
  ...
  r.value = n, o && (typeof n > "u" || n === l || n === "") && (h = !0, r.indeterminate = !0), this.table.browser != "firefox" && this.table.browser != "safari" && e(function() {
    a.getType() === "cell" && r.focus({ preventScroll: !0 });
  }), r.checked = d ? n === s.trueValue : n === !0 || n === "true" || n === "True" || n === 1;
  function c(f) {
    var p = r.checked;
    return d && p ? p = s.trueValue : u && !p && (p = s.falseValue), o ? f ? h ? l : p : r.checked && !h ? (r.checked = !1, r.indeterminate = !0, h = !0, l) : (h = !1, p) : p;
  }
...
function _s(a, e, t, i, s) {
  var n = a._getSelf().column, r, o, l;
  function h(d) {
...
`) && (c = "textarea");
  ...
  return r = s.editorLookup ? s.editorLookup(a) : h(a), s.paramsLookup && (l = typeof s.paramsLookup == "function" ? s.paramsLookup(r, a) : s.paramsLookup[r]), o = this.table.modules.edit.lookupEditor(r, n), o.call(this, a, e, t, i, l || {});
}
var Bs = {
  input: Ts,
  textarea: ks,
  ...
  edit(e, t, i) {
    ...
    function c(g) {
      if (s.currentCell === e && !l) {
        var E = s.chain("edit-success", [e, g], !0, !0);
        return E === !0 || s.table.options.validationMode === "highlight" ? (l = !0, s.clearEditor(), e.modules.edit || (e.modules.edit = {}), e.modules.edit.edited = !0, s.editedCells.indexOf(e) == -1 && s.editedCells.push(e), g = s.transformEmptyValues(g, e), e.setValue(g, !0), E === !0) : (l = !0, s.invalidEdit = !0, s.focusCellNoEvent(e, !0), r(), setTimeout(() => {
          l = !1;
        }, 10), !1);
      }
    }
    ...
    if (t && t.stopPropagation(), n = this.allowEdit(e), n || i) {
      if (s.cancelEdit(), s.currentCell = e, this.focusScrollAdjust(e), d = e.getComponent(), this.mouseClick && (this.mouseClick = !1, e.column.definition.cellClick && e.column.definition.cellClick.call(this.table, t, d)), e.column.definition.cellEditing && e.column.definition.cellEditing.call(this.table, d), this.dispatch("cell-editing", e), this.dispatchExternal("cellEditing", d), u = typeof e.column.modules.edit.params == "function" ? e.column.modules.edit.params(d) : e.column.modules.edit.params, h = e.column.modules.edit.editor.call(s, d, p, c, f, u), this.currentCell && h !== !1)
        if (h instanceof Node) {
          ...
          o.appendChild(h), r();
          for (var m = o.children, v = 0; v < m.length; v++)
...
C(Ie, "moduleName", "edit"), //load defaults
C(Ie, "editors", Bs);
let ct = Ie;
class Kt {
  constructor(e, t, i, s) {
...
const ie = class ie extends R {
  ...
  generateExportList(e, t, i, s) {
    var n, r, o, l;
    return this.cloneTableStyle = t, this.config = e || {}, this.colVisProp = s, this.colVisPropAttach = this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1), l = ie.columnLookups[i], l && (o = l.call(this.table), o = o.filter((h) => this.columnVisCheck(h))), n = this.config.columnHeaders !== !1 ? this.headersToExportRows(this.generateColumnGroupHeaders(o)) : [], o && (o = o.map((h) => h.getComponent())), r = this.bodyToExportRows(this.rowLookup(i), o), n.concat(r);
  }
  ...
  headersToExportRows(e) {
    ...
    function n(r, o) {
      var l = i - o;
      if (typeof t[o] > "u" && (t[o] = []), r.height = r.subGroups ? 1 : l - r.depth + 1, t[o].push(r), r.height > 1)
    ...
    return e.forEach(function(r) {
      ...
      r.forEach((l) => {
        if (l) {
          ...
          o.push(new st(h, l.column.getComponent(), l.width, l.height, l.depth));
        } else
          o.push(null);
  ...
  bodyToExportRows(e, t = []) {
    ...
    return t.length === 0 && this.table.columnManager.columnsByIndex.forEach((s) => {
      ...
      var r = s.getData(this.colVisProp), o = [], l = 0;
      switch (s.type) {
        case "group":
          l = s.level, o.push(new st(s.key, s.getComponent(), t.length, 1));
          break;
        case "calc":
        case "row":
          t.forEach((h) => {
            o.push(new st(h._column.getFieldValue(r), h, 1, 1));
          }), this.table.options.dataTree && this.config.dataTree !== !1 && (l = s.modules.dataTree.index);
          break;
      }
      i.push(new Kt(s.type, o, s.getComponent(), l));
    }), i;
  }
  ...
  generateHeaderElement(e, t, i) {
    ...
    return e.columns.forEach((n) => {
      if (n) {
        ...
        r.colSpan = n.width, r.rowSpan = n.height, r.innerHTML = n.value, this.cloneTableStyle && (r.style.boxSizing = "border-box"), o.forEach(function(l) {
          r.classList.add(l);
  ...
  generateRowElement(e, t, i) {
    ...
    if (s.classList.add("tabulator-print-table-row"), e.columns.forEach((n, r) => {
      if (n) {
        var o = document.createElement("td"), l = n.component._column, h = this.table, d = h.columnManager.findColumnIndex(l), u = n.value, c, f, p = {
          modules: {},
          getValue: function() {
            return u;
          },
        ...
        u instanceof Node ? o.appendChild(u) : o.innerHTML = u, f = ["padding-top", "padding-left", "padding-right", "padding-bottom", "border-top", "border-left", "border-right", "border-bottom", "color", "font-weight", "font-family", "font-size", "text-align"], l.isRowHeader ? (c = i.styleRowHeader, f.push("background-color")) : c = i.styleCells && i.styleCells[d] ? i.styleCells[d] : i.firstCell, c && (this.mapElementStyles(c, o, f), l.definition.align && (o.style.textAlign = l.definition.align)), this.table.options.dataTree && this.config.dataTree !== !1 && (t.treeElementField && t.treeElementField == l.field || !t.treeElementField && r == 0) && (e.component._row.modules.dataTree.controlEl && o.insertBefore(e.component._row.modules.dataTree.controlEl.cloneNode(!0), o.firstChild), e.component._row.modules.dataTree.branchEl && o.insertBefore(e.component._row.modules.dataTree.branchEl.cloneNode(!0), o.firstChild)), s.appendChild(o), p.modules.format && p.modules.format.renderedCallback && p.modules.format.renderedCallback();
      }
...
C(ie, "moduleName", "export"), C(ie, "columnLookups", Is), C(ie, "rowLookups", Vs);
let ft = ie;
var Ns = {
  //equal to
  "=": function(a, e, t, i) {
...
const Y = class Y extends R {
      ...
      if (typeof e.modules.filter.prevSuccess > "u" || e.modules.filter.prevSuccess !== r) {
        if (e.modules.filter.prevSuccess = r, e.modules.filter.emptyFunc(r))
          ...
          switch (e.modules.filter.value = r, typeof e.definition.headerFilterFunc) {
            case "string":
              Y.filters[e.definition.headerFilterFunc] ? (l = e.definition.headerFilterFunc, d = function(u) {
  ...
  generateHeaderFilterElement(e, t, i) {
    var s = this, n = e.modules.filter.success, r = e.getField(), o, l, h, d, u, c, f, p;
    ...
    if (e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), r) {
      ...
      if (l) {
        ...
        }, f = e.definition.headerFilterParams || {}, f = typeof f == "function" ? f.call(s.table, d) : f, h = l.call(this.table.modules.edit, d, v, n, m, f), !h) {
        ...
        s.langBind("headerFilters|columns|" + e.definition.field, function(g) {
          ...
          var E = this.table.columnManager.contentsElement.scrollLeft, L = this.table.rowManager.element.scrollLeft;
          E !== L && (this.table.rowManager.scrollHorizontal(E), this.table.columnManager.scrollHorizontal(E));
        }), u = !1, c = function(g) {
...
C(Y, "moduleName", "filter"), //load defaults
C(Y, "filters", Ns);
let pt = Y;
function Ws(a, e, t) {
...
function Us(a, e, t) {
  var i = parseFloat(a.getValue()), s = "", n, r, o, l, h, d = e.decimal || ".", u = e.thousand || ",", c = e.negativeSign || "-", f = e.symbol || "", p = !!e.symbolAfter, m = typeof e.precision < "u" ? e.precision : 2;
  if (isNaN(i))
    return this.emptyToSpace(this.sanitizeHTML(a.getValue()));
  if (i < 0 && (i = Math.abs(i), s = c), n = m !== !1 ? i.toFixed(m) : i, n = String(n).split("."), r = n[0], o = n.length > 1 ? d + n[1] : "", e.thousand !== !1)
    for (l = /(\d+)(\d{3})/; l.test(r); )
      r = r.replace(l, "$1" + u + "$2");
  return h = r + o, s === !0 ? (h = "(" + h + ")", p ? h + f : f + h) : p ? s + h + f : s + f + h;
}
function Xs(a, e, t) {
  var i = a.getValue(), s = e.urlPrefix || "", n = e.download, r = i, o = document.createElement("a"), l;
  function h(d, u) {
    var c = d.shift(), f = u[c];
    return d.length && typeof f == "object" ? h(d, f) : f;
  }
  if (e.labelField && (l = a.getData(), r = h(e.labelField.split(this.table.options.nestedFieldSeparator), l)), e.label)
  ...
  if (r) {
    if (e.urlField && (l = a.getData(), i = F.retrieveNestedData(this.table.options.nestedFieldSeparator, e.urlField, l)), e.url)
      switch (typeof e.url) {
        case "string":
          i = e.url;
          break;
...
function Ks(a, e, t) {
  ...
  if (typeof i < "u") {
    var l;
    return i.isDateTime(o) ? l = o : s === "iso" ? l = i.fromISO(String(o)) : l = i.fromFormat(String(o), s), l.isValid ? (e.timezone && (l = l.setZone(e.timezone)), l.toFormat(n)) : r === !0 || !o ? o : typeof r == "function" ? r(o) : r;
  } else
    console.error("Format Error - 'datetime' formatter is dependant on luxon.js");
}
function $s(a, e, t) {
  var i = this.table.dependencyRegistry.lookup(["luxon", "DateTime"], "DateTime"), s = e.inputFormat || "yyyy-MM-dd HH:mm:ss", n = typeof e.invalidPlaceholder < "u" ? e.invalidPlaceholder : "", r = typeof e.suffix < "u" ? e.suffix : !1, o = typeof e.unit < "u" ? e.unit : "days", l = typeof e.humanize < "u" ? e.humanize : !1, h = typeof e.date < "u" ? e.date : i.now(), d = a.getValue();
  if (typeof i < "u") {
    var u;
    return i.isDateTime(d) ? u = d : s === "iso" ? u = i.fromISO(String(d)) : u = i.fromFormat(String(d), s), u.isValid ? l ? u.diff(h, o).toHuman() + (r ? " " + r : "") : parseInt(u.diff(h, o)[o]) + (r ? " " + r : "") : n === !0 ? d : typeof n == "function" ? n(d) : n;
  } else
...
function Qs(a, e, t) {
  var i = a.getValue(), s = a.getElement(), n = e && e.stars ? e.stars : 5, r = document.createElement("span"), o = document.createElementNS("http://www.w3.org/2000/svg", "svg"), l = '<polygon fill="#FFEA00" stroke="#C1AB60" stroke-width="37.6152" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="259.216,29.942 330.27,173.919 489.16,197.007 374.185,309.08 401.33,467.31 259.216,392.612 117.104,467.31 144.25,309.08 29.274,197.007 188.165,173.919 "/>', h = '<polygon fill="#D2D2D2" stroke="#686868" stroke-width="37.6152" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" points="259.216,29.942 330.27,173.919 489.16,197.007 374.185,309.08 401.33,467.31 259.216,392.612 117.104,467.31 144.25,309.08 29.274,197.007 188.165,173.919 "/>';
  ...
  for (var d = 1; d <= n; d++) {
    var u = o.cloneNode(!0);
    u.innerHTML = d <= i ? l : h, r.appendChild(u);
  }
  return s.style.whiteSpace = "nowrap", s.style.overflow = "hidden", s.style.textOverflow = "ellipsis", s.setAttribute("aria-label", i), r;
}
function Zs(a, e, t) {
  var i = this.sanitizeHTML(a.getValue()) || 0, s = document.createElement("span"), n = e && e.max ? e.max : 100, r = e && e.min ? e.min : 0, o = e && typeof e.color < "u" ? e.color : ["red", "orange", "green"], l = "#666666", h, d;
...
function en(a, e = {}, t) {
  var i = this.sanitizeHTML(a.getValue()) || 0, s = a.getElement(), n = e.max ? e.max : 100, r = e.min ? e.min : 0, o = e.legendAlign ? e.legendAlign : "center", l, h, d, u, c;
  ...
  if (p.style.position = "relative", p.style.width = "100%", p.style.height = "100%", u) {
    ...
    m.style.position = "absolute", m.style.top = 0, m.style.left = 0, m.style.textAlign = o, m.style.width = "100%", m.style.color = c, m.innerHTML = u;
  }
  return t(function() {
    if (!(a instanceof gi)) {
...
function rn(a, e, t) {
  var i = a.getValue(), s = e.size || 15, n = s + "px", r, o, l = e.hasOwnProperty("onValue") ? e.onValue : !0, h = e.hasOwnProperty("offValue") ? e.offValue : !1, d = e.onTruthy ? i : i === l;
...
function hn(a, e, t) {
  ...
  return e.valueMap && (typeof e.valueMap == "string" ? r = function(o) {
    return o.map((l) => F.retrieveNestedData(n.options.nestedFieldSeparator, e.valueMap, l));
...
C(se, "moduleName", "format"), //load defaults
C(se, "formatters", un);
let mt = se;
class Ci extends R {
  constructor(e) {
  ...
  configureGroupSetup() {
    if (this.table.options.groupBy) {
      ...
      if (this.allowedValues = this.table.options.groupValues, Array.isArray(e) && Array.isArray(i) && e.length > i.length && console.warn("Error creating group headers, groupHeader array is shorter than groupBy array"), this.headerGenerator = [function() {
        ...
        this.headerGenerator[0] = (o, l, h) => (typeof o > "u" ? "" : o) + "<span>(" + l + " " + (l === 1 ? n : r.groups.items) + ")</span>";
...
C(ne, "moduleName", "history"), C(ne, "moduleExtensions", bn), //load defaults
C(ne, "undoers", fn), C(ne, "redoers", pn);
let gt = ne;
class Ri extends R {
  constructor(e) {
  ...
  parseTable() {
    ...
    for (var r = 0; r < s.length; r++) {
      var o = s[r], l = o.getElementsByTagName("td"), h = {};
...
C(Ri, "moduleName", "htmlTableImport");
function vn(a) {
  var e = [], t = 0, i = 0, s = !1;
...
C(Ve, "moduleName", "import"), //load defaults
C(Ve, "importers", En);
let bt = Ve;
class xi extends R {
  constructor(e) {
  ...
  dispatchEvent(e, t, i) {
    ...
    this.columnSubscribers[e] && (i instanceof Xe ? n = i.column.definition[e] : i instanceof we && (n = i.definition[e]), n && n(t, s)), this.dispatchExternal(e, t, s);
  }
}
C(xi, "moduleName", "interaction");
var Rn = {
  navPrev: "shift + 9",
  navNext: 9,
  navUp: 38,
...
C(re, "moduleName", "keybindings"), //load defaults
C(re, "bindings", Rn), C(re, "actions", xn);
let vt = re;
class Ti extends R {
  constructor(e) {
  ...
  loadMenu(e, t, i, s, n) {
    var r = !(e instanceof MouseEvent), o = document.createElement("div"), l;
...
class ki extends R {
  ...
  bindTouchEvents(e) {
    var t = e.getElement(), i = !1, s, n, r, o, l, h;
    t.addEventListener("touchstart", (d) => {
      this.checkTimeout = setTimeout(() => {
        this.touchMove = !0, s = e.nextColumn(), r = s ? s.getWidth() / 2 : 0, n = e.prevColumn(), o = n ? n.getWidth() / 2 : 0, l = 0, h = 0, i = !1, this.startMove(d, e);
      }, this.checkPeriod);
    }, { passive: !0 }), t.addEventListener("touchmove", (d) => {
      var u, c;
      this.moving && (this.moveHover(d), i || (i = d.touches[0].pageX), u = d.touches[0].pageX - i, u > 0 ? s && u - l > r && (c = s, c !== e && (i = d.touches[0].pageX, c.getElement().parentNode.insertBefore(this.placeholderElement, c.getElement().nextSibling), this.moveColumn(c, !0))) : n && -u - h > o && (c = n, c !== e && (i = d.touches[0].pageX, c.getElement().parentNode.insertBefore(this.placeholderElement, c.getElement()), this.moveColumn(c, !1))), c && (s = c.nextColumn(), l = r, r = s ? s.getWidth() / 2 : 0, n = c.prevColumn(), h = o, o = n ? n.getWidth() / 2 : 0));
...
const ce = class ce extends R {
  ...
  dropComplete(e, t, i) {
    ...
    if (i) {
      switch (typeof this.table.options.movableRowsSender) {
        case "string":
          s = ce.senders[this.table.options.movableRowsSender];
          break;
        case "function":
  ...
  tableRowDrop(e, t) {
    ...
    switch (e.stopImmediatePropagation(), typeof this.table.options.movableRowsReceiver) {
      case "string":
        i = ce.receivers[this.table.options.movableRowsReceiver];
        break;
      case "function":
...
C(ce, "moduleName", "moveRow"), //load defaults
C(ce, "senders", Tn), C(ce, "receivers", kn);
let wt = ce;
var Mn = {};
const Te = class Te extends R {
  constructor(e) {
  ...
  transformRow(e, t, i) {
    ...
    return this.enabled && this.table.columnManager.traverse((r) => {
      var o, l, h;
      r.modules.mutate && (o = r.modules.mutate[s] || r.modules.mutate.mutator || !1, o && (n = r.getFieldValue(typeof i < "u" ? i : e), (t == "data" && !i || typeof n < "u") && (h = r.getComponent(), l = typeof o.params == "function" ? o.params(n, e, t, h) : o.params, r.setFieldValue(e, o.mutator(n, e, t, l, h)))));
    }), e;
  }
...
C(Te, "moduleName", "mutator"), //load defaults
C(Te, "mutators", Mn);
let Ct = Te;
function Ln(a, e, t, i, s) {
  var n = document.createElement("span"), r = document.createElement("span"), o = document.createElement("span"), l = document.createElement("span"), h = document.createElement("span"), d = document.createElement("span");
  return this.table.modules.localize.langBind("pagination|counter|showing", (u) => {
    ...
    d.innerHTML = u;
  }), i ? (o.innerHTML = " " + e + "-" + Math.min(e + a - 1, i) + " ", h.innerHTML = " " + i + " ", n.appendChild(r), n.appendChild(o), n.appendChild(l), n.appendChild(h), n.appendChild(d)) : (o.innerHTML = " 0 ", n.appendChild(r), n.appendChild(o), n.appendChild(d)), n;
}
function Sn(a, e, t, i, s) {
  ...
  return this.table.modules.localize.langBind("pagination|counter|showing", (u) => {
    ...
    d.innerHTML = u;
  }), n.appendChild(r), n.appendChild(o), n.appendChild(l), n.appendChild(h), n.appendChild(d), n;
}
var Dn = {
  rows: Ln,
  pages: Sn
...
const Ne = class Ne extends R {
  ...
  getRows(e) {
    var t = 0, i, s, n, r, o = e.filter((l) => l.type === "row");
    if (this.mode == "local") {
...
C(Ne, "moduleName", "page"), //load defaults
C(Ne, "pageCounters", Dn);
let yt = Ne;
var zn = {
  local: function(a, e) {
...
const N = class N extends R {
  ...
  parseColumns(e) {
    ...
    return e.forEach((s) => {
      ...
      s.isGroup ? (n.title = r.title, n.columns = this.parseColumns(s.getColumns())) : (n.field = s.getField(), this.config.columns === !0 || this.config.columns == null ? (o = Object.keys(r), o.push("width"), o.push("visible")) : o = this.config.columns, o.forEach((l) => {
        switch (l) {
          case "width":
            n.width = s.getWidth();
            break;
...
C(N, "moduleName", "persistence"), C(N, "moduleInitOrder", -10), //load defaults
C(N, "readers", zn), C(N, "writers", Fn);
let Et = N;
class Mi extends R {
  constructor(e) {
  ...
  loadPopup(e, t, i, s, n) {
    var r = !(e instanceof MouseEvent), o, l;
    i instanceof HTMLElement ? o = i : (o = document.createElement("div"), o.innerHTML = i), o.classList.add("tabulator-popup"), o.addEventListener("click", (h) => {
      h.stopPropagation();
    }), r || e.preventDefault(), l = this.popup(o), typeof s == "function" && l.renderCallback(s), e ? l.show(e) : l.show(t.getElement(), n || "center"), l.hideOnBlur(() => {
      this.dispatchExternal("popupClosed", t.getComponent());
    }), this.dispatchExternal("popupOpened", t.getComponent());
  }
}
C(Mi, "moduleName", "popup");
class Li extends R {
  constructor(e) {
...
class Si extends R {
  ...
  watchData(e) {
    ...
    this.currentVersion++, i = this.currentVersion, this.unwatchData(), this.data = e, this.origFuncs.push = e.push, Object.defineProperty(this.data, "push", {
      ...
      configurable: !0,
      value: function() {
        var s = Array.from(arguments), n = s[0] < 0 ? e.length + s[0] : s[0], r = s[1], o = s[2] ? s.slice(2) : !1, l, h;
        if (!t.blocked && i === t.currentVersion) {
          if (t.block("data-splice"), o && (l = e[n] ? t.table.rowManager.getRowFromDataObject(e[n]) : !1, l ? o.forEach((u) => {
            t.table.rowManager.addRowActual(u, !0, l, !0);
  ...
  watchKey(e, t, i) {
    ...
    Object.defineProperty(t, i, {
      set: (l) => {
        if (r = l, !s.blocked && o === s.currentVersion) {
          s.block("key");
          var h = {};
...
class Di extends R {
  ...
  initializeColumn(e, t, i, s) {
    var n = this, r = !1, o = i.definition.resizable, l = {}, h = i.getLastColumn();
    if (e === "header" && (r = i.definition.formatter == "textarea" || i.definition.variableHeight, l = { variableHeight: r }), (o === !0 || o == e) && this._checkResizability(h)) {
  ...
  calcGuidePosition(e, t, i) {
    var s = typeof e.clientX > "u" ? e.touches[0].clientX : e.clientX, n = i.getBoundingClientRect().x - this.table.element.getBoundingClientRect().x, r = this.table.element.getBoundingClientRect().x, o = t.element.getBoundingClientRect().left - r, l = s - this.startX, h = Math.max(n + l, o + t.minWidth);
...
class zi extends R {
  ...
  calcGuidePosition(e, t, i) {
    var s = typeof e.screenY > "u" ? e.touches[0].screenY : e.screenY, n = i.getBoundingClientRect().y - this.table.element.getBoundingClientRect().y, r = this.table.element.getBoundingClientRect().y, o = t.element.getBoundingClientRect().top - r, l = s - this.startY;
  ...
  _mouseDown(e, t, i) {
    ...
    function o(l) {
      s.table.options.resizableRowGuide && (s.resize(l, t), n.remove()), document.body.removeEventListener("mouseup", r), document.body.removeEventListener("mousemove", r), i.removeEventListener("touchmove", r), i.removeEventListener("touchend", o), s.table.element.classList.remove("tabulator-block-select"), s.dispatchExternal("rowResized", t.getComponent());
    }
...
class Rt extends R {
  ...
  formatCollapsedData(e) {
    ...
    return e.forEach((i) => {
      var s = document.createElement("tr"), n = document.createElement("td"), r = document.createElement("td"), o, l = document.createElement("strong");
...
C(Rt, "moduleName", "responsiveLayout"), C(Rt, "moduleExtensions", On);
function Pn(a, e, t) {
...
class xt extends R {
  ...
  handleComplexRowClick(e, t) {
    if (t.shiftKey) {
      ...
      var i = this.table.rowManager.getDisplayRowIndex(this.lastClickedRow), s = this.table.rowManager.getDisplayRowIndex(e), n = i <= s ? i : s, r = i >= s ? i : s, o = this.table.rowManager.getDisplayRows().slice(0), l = o.splice(n, r - n + 1);
...
C(xt, "moduleName", "selectRow"), C(xt, "moduleExtensions", An);
class _n {
  constructor(e) {
...
var In = {
  ...
  range: function(a) {
    var e = [], t = this.table.modules.selectRange.activeRange, i = !1, s, n, r, o, l;
    return l = a.length, t && (s = t.getBounds(), n = s.start, s.start === s.end && (i = !0), n && (e = this.table.rowManager.activeRows.slice(), r = e.indexOf(n.row), i ? o = a.length : o = e.indexOf(s.end.row) - r + 1, r > -1 && (this.table.blockRedraw(), e = e.slice(r, r + o), e.forEach((h, d) => {
      h.updateData(a[d % l]);
    }), this.table.restoreRedraw()))), e;
  }
}, Wn = {
  range: function(a) {
    var e = [], t = [], i = this.table.modules.selectRange.activeRange, s = !1, n, r, o, l, h;
    return i && (n = i.getBounds(), r = n.start, n.start === n.end && (s = !0), r && (a = a.split(`
`), a.forEach(function(d) {
      e.push(d.split("	"));
    }), e.length && (l = this.table.columnManager.getVisibleColumnsByIndex(), h = l.indexOf(r.column), h > -1))) ? (s ? o = e[0].length : o = l.indexOf(n.end.column) - h + 1, l = l.slice(h, h + o), e.forEach((d) => {
      var u = {}, c = d.length;
...
class Ke extends R {
  ...
  navigate(e, t, i) {
    ...
    if (this.rowHeader && h === 0 && (h = 1), t || n.setStart(l, h), n.setEnd(l, h), t || (this.selecting = "cell"), s = o.top !== n.top || o.bottom !== n.bottom || o.left !== n.left || o.right !== n.right, s)
      return d = this.getRowByRangePos(n.end.row), u = this.getColumnByRangePos(n.end.col), c = d.getElement().getBoundingClientRect(), p = u.getElement().getBoundingClientRect(), f = this.table.rowManager.getElement().getBoundingClientRect(), m = this.table.columnManager.getElement().getBoundingClientRect(), c.top >= f.top && c.bottom <= f.bottom || (d.getElement().parentNode && u.getElement().parentNode ? this.autoScroll(n, d.getElement(), u.getElement()) : d.getComponent().scrollTo(void 0, !1)), p.left >= m.left + this.getRowHeaderWidth() && p.right <= m.right || (d.getElement().parentNode && u.getElement().parentNode ? this.autoScroll(n, d.getElement(), u.getElement()) : u.getComponent().scrollTo(void 0, !1)), this.layoutElement(), !0;
  }
  rangeRemoved(e) {
  ...
  findJumpCellLeft(e, t) {
    var i = this.getRowByRangePos(e), s = this.getTableColumns(), n = this.isEmpty(i.getData()[s[t].getField()]), r = s[t - 1] ? this.isEmpty(i.getData()[s[t - 1].getField()]) : !1, o = this.rowHeader ? s.slice(1, t) : s.slice(0, t), l = this.findJumpCol(i, o, !0, n, r);
  ...
  autoScroll(e, t, i) {
    var s = this.table.rowManager.element, n, r, o, l;
    ...
    }, o = r.left < n.left && n.left < r.right && r.left < n.right && n.right < r.right, l = r.top < n.top && n.top < r.bottom && r.top < n.bottom && n.bottom < r.bottom, o || (n.left < r.left ? s.scrollLeft = n.left - this.getRowHeaderWidth() : n.right > r.right && (s.scrollLeft = Math.min(n.right - s.clientWidth, n.left - this.getRowHeaderWidth()))), l || (n.top < r.top ? s.scrollTop = n.top : n.bottom > r.bottom && (s.scrollTop = n.bottom - s.clientHeight));
  }
  ///////////////////////////////////
  ///////       Layout        ///////
  ///////////////////////////////////
...
C(Ke, "moduleName", "selectRange"), C(Ke, "moduleInitOrder", 1), C(Ke, "moduleExtensions", Un);
function Xn(a, e, t, i, s, n, r) {
  var o = r.alignEmptyValues, l = r.decimalSeparator, h = r.thousandSeparator, d = 0;
  if (a = String(a), e = String(e), h && (a = a.split(h).join(""), e = e.split(h).join("")), l && (a = a.split(l).join("."), e = e.split(l).join(".")), a = parseFloat(a), e = parseFloat(e), isNaN(a))
    d = isNaN(e) ? 0 : -1;
  else if (isNaN(e))
    d = 1;
  else
...
function Jn(a, e, t, i, s, n, r) {
  var o = r.alignEmptyValues, l = 0, h;
  if (!a)
    l = e ? -1 : 0;
  else if (!e)
    l = 1;
    ...
    return String(a).toLowerCase().localeCompare(String(e).toLowerCase(), h);
  }
  return (o === "top" && n === "desc" || o === "bottom" && n === "asc") && (l *= -1), l;
}
function jt(a, e, t, i, s, n, r) {
  var o = this.table.dependencyRegistry.lookup(["luxon", "DateTime"], "DateTime"), l = r.format || "dd/MM/yyyy HH:mm:ss", h = r.alignEmptyValues, d = 0;
  if (typeof o < "u") {
    if (o.isDateTime(a) || (l === "iso" ? a = o.fromISO(String(a)) : a = o.fromFormat(String(a), l)), o.isDateTime(e) || (l === "iso" ? e = o.fromISO(String(e)) : e = o.fromFormat(String(e), l)), !a.isValid)
      d = e.isValid ? -1 : 0;
    else if (!e.isValid)
      d = 1;
    else
...
function qn(a, e, t, i, s, n, r) {
  return r.format || (r.format = "dd/MM/yyyy"), jt.call(this, a, e, t, i, s, n, r);
}
function Kn(a, e, t, i, s, n, r) {
  return r.format || (r.format = "HH:mm"), jt.call(this, a, e, t, i, s, n, r);
}
function $n(a, e, t, i, s, n, r) {
  var o = a === !0 || a === "true" || a === "True" || a === 1 ? 1 : 0, l = e === !0 || e === "true" || e === "True" || e === 1 ? 1 : 0;
  return o - l;
}
function Yn(a, e, t, i, s, n, r) {
  var o = r.type || "length", l = r.alignEmptyValues, h = 0, d = this.table, u;
  r.valueMap && (typeof r.valueMap == "string" ? u = function(f) {
    return f.map((p) => F.retrieveNestedData(d.options.nestedFieldSeparator, r.valueMap, p));
  } : u = r.valueMap);
  function c(f) {
    var p;
    switch (u && (f = u(f)), o) {
  ...
  if (!Array.isArray(a))
    ...
    return o === "string" ? String(c(a)).toLowerCase().localeCompare(String(c(e)).toLowerCase()) : c(e) - c(a);
  return (l === "top" && n === "desc" || l === "bottom" && n === "asc") && (h *= -1), h;
}
function Qn(a, e, t, i, s, n, r) {
  var o = typeof a > "u" ? 0 : 1, l = typeof e > "u" ? 0 : 1;
  return o - l;
}
function Zn(a, e, t, i, s, n, r) {
  var o, l, h, d, u = 0, c, f = /(\d+)|(\D+)/g, p = /\d/, m = r.alignEmptyValues, v = 0;
  if (!a && a !== 0)
    v = !e && e !== 0 ? 0 : -1;
  else if (!e && e !== 0)
    v = 1;
    ...
    if (o = String(a).toLowerCase(), l = String(e).toLowerCase(), o === l) return 0;
    if (!(p.test(o) && p.test(l))) return o > l ? 1 : -1;
    for (o = o.match(f), l = l.match(f), c = o.length > l.length ? l.length : o.length; u < c; )
      if (h = o[u], d = l[u++], h !== d)
...
const fe = class fe extends R {
    ...
    if (e.modules.sort = {
      ...
      e.titleHolderElement.appendChild(s), e.modules.sort.element = s, this.setColumnHeaderSortIcon(e, "none"), this.table.options.headerSortClickElement === "icon" && s.addEventListener("mousedown", (n) => {
        ...
        if (e.modules.sort) {
          ...
          this.table.options.columnHeaderSortMulti && (n.shiftKey || n.ctrlKey) ? (o = this.getSort(), l = o.findIndex((h) => h.field === e.getField()), l > -1 ? (o[l].dir = r, l = o.splice(l, 1)[0], r != "none" && o.push(l)) : r != "none" && o.push({ column: e, dir: r }), this.setSort(o)) : r == "none" ? this.clear() : this.setSort(e, r), this.refreshSort();
        }
      });
    }
  }
  ...
  _sortRow(e, t, i, s, n) {
    var r, o, l = s == "asc" ? e : t, h = s == "asc" ? t : e;
    return e = i.getFieldValue(l.getData()), t = i.getFieldValue(h.getData()), e = typeof e < "u" ? e : "", t = typeof t < "u" ? t : "", r = l.getComponent(), o = h.getComponent(), i.modules.sort.sorter.call(this, e, t, r, o, i.getComponent(), s, n);
  }
};
C(fe, "moduleName", "sort"), //load defaults
C(fe, "sorters", er);
let Tt = fe;
class tr {
  constructor(e, t) {
...
Data:     `, e), !1;
  ...
  lookupSheet(e) {
    return e ? e instanceof $t ? e : e instanceof Hi ? e._sheet : this.sheets.find((t) => t.key === e) || !1 : this.activeSheet;
  }
  ///////////////////////////////////
  //////// Public Functions /////////
  ///////////////////////////////////
...
class Pi extends R {
  ...
  loadTooltip(e, t, i) {
    ...
    typeof i == "function" && (i = i(e, t.getComponent(), o)), i instanceof HTMLElement ? s = i : (s = document.createElement("div"), i === !0 && (t instanceof Xe ? i = t.value : t.definition.field ? this.langBind("columns|" + t.definition.field, (l) => {
...
C(We, "moduleName", "validate"), //load defaults
C(We, "validators", ir);
let kt = We;
...
class or extends B {
        ...
        switch (typeof n) {
          ...
          case "object":
            Array.isArray(n) ? t.forEach((r) => {
              var o = n.find((l) => l.field === r.field);
              o && Object.assign(r, o);
            }) : t.forEach((r) => {
  ...
  _moveColumnInArray(e, t, i, s, n) {
    var r = e.indexOf(t), o, l = [];
    r > -1 && (e.splice(r, 1), o = e.indexOf(i), o > -1 ? s && (o = o + 1) : o = r, e.splice(o, 0, t), n && (l = this.chain("column-moving-rows", [t, i, s], null, []) || [], l = l.concat(this.table.rowManager.rows), l.forEach(function(h) {
      if (h.cells.length) {
...
class lr extends et {
  ...
  rerenderRows(e) {
    for (var t = this.elementVertical.scrollTop, i = !1, s = !1, n = this.table.rowManager.scrollLeft, r = this.rows(), o = this.vDomTop; o <= this.vDomBottom; o++)
      if (r[o]) {
        var l = t - r[o].getElement().offsetTop;
        if (s === !1 || Math.abs(l) < s)
          s = l, i = o;
        else
          break;
  ...
  _virtualRenderFill(e, t, i) {
    var s = this.tableElement, n = this.elementVertical, r = 0, o = 0, l = 0, h = 0, d = 0, u = 0, c = this.rows(), f = c.length, p = 0, m, v, g = [], E = 0, L = 0, H = this.table.rowManager.fixedHeight, S = this.elementVertical.clientHeight, _ = this.table.options.rowHeight, y = !0;
    if (e = e || 0, i = i || 0, !e)
      this.clear();
    else {
      for (; s.firstChild; ) s.removeChild(s.firstChild);
      h = (f - e + 1) * this.vDomRowHeight, h < S && (e -= Math.ceil((S - h) / this.vDomRowHeight), e < 0 && (e = 0)), r = Math.min(Math.max(Math.floor(this.vDomWindowBuffer / this.vDomRowHeight), this.vDomWindowMinMarginRows), e), e -= r;
    }
    if (f && F.elVisible(this.elementVertical)) {
      for (this.vDomTop = e, this.vDomBottom = e - 1, H || this.table.options.maxHeight ? (_ && (L = S / _ + this.vDomWindowBuffer / _), L = Math.max(this.vDomWindowMinTotalRows, Math.ceil(L))) : L = f; (L == f || o <= S + this.vDomWindowBuffer || E < this.vDomWindowMinTotalRows) && this.vDomBottom < f - 1; ) {
        for (g = [], v = document.createDocumentFragment(), u = 0; u < L && this.vDomBottom < f - 1; )
          p = this.vDomBottom + 1, m = c[p], this.styleRow(m, p), m.initialize(!1, !0), !m.heightInitialized && !this.table.options.rowHeight && m.clearCellHeight(), v.appendChild(m.getElement()), g.push(m), this.vDomBottom++, u++;
        if (!g.length)
          break;
        s.appendChild(v), g.forEach((w) => {
          w.rendered(), w.heightInitialized || w.calcHeight(!0);
        }), g.forEach((w) => {
          w.heightInitialized || w.setCellHeight();
        }), g.forEach((w) => {
          l = w.getHeight(), E < r ? d += l : o += l, l > this.vDomWindowBuffer && (this.vDomWindowBuffer = l * 2), E++;
        }), y = this.table.rowManager.adjustTableSize(), S = this.elementVertical.clientHeight, y && (H || this.table.options.maxHeight) && (_ = o / E, L = Math.max(this.vDomWindowMinTotalRows, Math.ceil(S / _ + this.vDomWindowBuffer / _)));
      }
      e ? (this.vDomTopPad = t ? this.vDomRowHeight * this.vDomTop + i : this.scrollTop - d, this.vDomBottomPad = this.vDomBottom == f - 1 ? 0 : Math.max(this.vDomScrollHeight - this.vDomTopPad - o - d, 0)) : (this.vDomTopPad = 0, this.vDomRowHeight = Math.floor((o + d) / E), this.vDomBottomPad = this.vDomRowHeight * (f - this.vDomBottom - 1), this.vDomScrollHeight = d + o + this.vDomBottomPad - S), s.style.paddingTop = this.vDomTopPad + "px", s.style.paddingBottom = this.vDomBottomPad + "px", t && (this.scrollTop = this.vDomTopPad + d + i - (this.elementVertical.scrollWidth > this.elementVertical.clientWidth ? this.elementVertical.offsetHeight - S : 0)), this.scrollTop = Math.min(this.scrollTop, this.elementVertical.scrollHeight - S), this.elementVertical.scrollWidth > this.elementVertical.clientWidth && t && (this.scrollTop += this.elementVertical.offsetHeight - S), this.vDomScrollPosTop = this.scrollTop, this.vDomScrollPosBottom = this.scrollTop, n.scrollTop = this.scrollTop, this.dispatch("render-virtual-fill");
    }
  }
  _addTopRow(e, t) {
    for (var i = this.tableElement, s = [], n = 0, r = this.vDomTop - 1, o = 0, l = !0; l; )
      if (this.vDomTop) {
        let h = e[r], d, u;
        h && o < this.vDomMaxRenderChain ? (d = h.getHeight() || this.vDomRowHeight, u = h.initialized, t >= d ? (this.styleRow(h, r), i.insertBefore(h.getElement(), i.firstChild), (!h.initialized || !h.heightInitialized) && s.push(h), h.initialize(), u || (d = h.getElement().offsetHeight, d > this.vDomWindowBuffer && (this.vDomWindowBuffer = d * 2)), t -= d, n += d, this.vDomTop--, r--, o++) : l = !1) : l = !1;
      } else
        l = !1;
    for (let h of s)
      h.clearCellHeight();
  ...
  _removeTopRow(e, t) {
    for (var i = [], s = 0, n = 0, r = !0; r; ) {
      ...
      o && n < this.vDomMaxRenderChain ? (l = o.getHeight() || this.vDomRowHeight, t >= l ? (this.vDomTop++, t -= l, s += l, i.push(o), n++) : r = !1) : r = !1;
    }
    for (let o of i) {
      let l = o.getElement();
  ...
  _addBottomRow(e, t) {
    for (var i = this.tableElement, s = [], n = 0, r = this.vDomBottom + 1, o = 0, l = !0; l; ) {
      let h = e[r], d, u;
      h && o < this.vDomMaxRenderChain ? (d = h.getHeight() || this.vDomRowHeight, u = h.initialized, t >= d ? (this.styleRow(h, r), i.appendChild(h.getElement()), (!h.initialized || !h.heightInitialized) && s.push(h), h.initialize(), u || (d = h.getElement().offsetHeight, d > this.vDomWindowBuffer && (this.vDomWindowBuffer = d * 2)), t -= d, n += d, this.vDomBottom++, r++, o++) : l = !1) : l = !1;
    }
    for (let h of s)
      h.clearCellHeight();
  ...
  _removeBottomRow(e, t) {
    for (var i = [], s = 0, n = 0, r = !0; r; ) {
      ...
      o && n < this.vDomMaxRenderChain ? (l = o.getHeight() || this.vDomRowHeight, t >= l ? (this.vDomBottom--, t -= l, s += l, i.push(o), n++) : r = !1) : r = !1;
    }
    for (let o of i) {
      let l = o.getElement();
      l.parentNode && l.parentNode.removeChild(l);
...
Data:     `, e);
  ...
  addRowActual(e, t, i, s) {
    var n = e instanceof I ? e : new I(e || {}, this), r = this.findAddRowPos(t), o = -1, l, h;
    return i || (h = this.chain("row-adding-position", [n, r], null, { index: i, top: r }), i = h.index, r = h.top), typeof i < "u" && (i = this.findRow(i)), i = this.chain("row-adding-index", [n, i, r], null, i), i && (o = this.rows.indexOf(i)), i && o > -1 ? (l = this.activeRows.indexOf(i), this.displayRowIterator(function(d) {
      var u = d.indexOf(i);
      u > -1 && d.splice(r ? u : u + 1, 0, n);
    }), l > -1 && this.activeRows.splice(r ? l : l + 1, 0, n), this.rows.splice(r ? o : o + 1, 0, n)) : r ? (this.displayRowIterator(function(d) {
      d.unshift(n);
...
class ur extends B {
  ...
  bindComponents(e, t) {
    ...
    for (let l of i) {
      let h, d = t[l], u = this.previousTargets[l];
      if (u && u.target === d)
        h = u.component;
      else
        switch (l) {
...
function Cr(a, e) {
  var t = this.table.rowManager.element.getBoundingClientRect().width, i = 0, s = 0, n = 0, r = 0, o = [], l = [], h = 0, d = 0, u = 0;
  function c(p) {
    var m;
    return typeof p == "string" ? p.indexOf("%") > -1 ? m = t / 100 * parseInt(p) : m = parseInt(p) : m = p, m;
  }
  function f(p, m, v, g) {
    var E = [], L = 0, H = 0, S = 0, _ = n, y = 0, w = 0, P = [];
    function M(x) {
    ...
    return p.forEach(function(x, de) {
      var Xt = g ? U(x) : M(x);
      x.column.minWidth >= Xt ? E.push(x) : x.column.maxWidth && x.column.maxWidth < Xt ? (x.width = x.column.maxWidth, m -= x.column.maxWidth, _ -= g ? x.column.definition.widthShrink || 1 : x.column.definition.widthGrow || 1, _ && (v = Math.floor(m / _))) : (P.push(x), w += g ? x.column.definition.widthShrink || 1 : x.column.definition.widthGrow || 1);
    }), E.length ? (E.forEach(function(x) {
      L += g ? x.width - x.column.minWidth : x.column.minWidth, x.width = x.column.minWidth;
    }), H = m - L, S = w ? Math.floor(H / w) : H, y = f(P, H, S, g)) : (y = w ? m - Math.floor(m / w) * w : m, P.forEach(function(x) {
      x.width = g ? U(x) : M(x);
    })), y;
  }
  this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && this.table.modules.responsiveLayout.update(), this.table.rowManager.element.scrollHeight > this.table.rowManager.element.clientHeight && (t -= this.table.rowManager.element.offsetWidth - this.table.rowManager.element.clientWidth), a.forEach(function(p) {
    var m, v, g;
    ...
    s -= p.width;
  }), d = Math.abs(u) + s, d > 0 && h && (u = f(l, d, Math.floor(d / h), !0)), u && l.length && (l[l.length - 1].width -= u), o.forEach(function(p) {
...
C(ke, "moduleName", "layout"), //load defaults
C(ke, "modes", yr);
let Mt = ke;
var Er = {
  default: {
...
const je = class je extends R {
  ...
  initialize() {
    this.langList = F.deepClone(je.langs), this.table.options.columnDefaults.headerFilterPlaceholder !== !1 && this.setHeaderFilterPlaceholder(this.table.options.columnDefaults.headerFilterPlaceholder);
...
C(je, "moduleName", "localize"), //load defaults
C(je, "langs", Er);
let Lt = je;
class _i extends R {
  constructor(e) {
...
const G = class G {
  static findTable(e) {
    var t = G.registry.lookupTable(e, !0);
...
C(G, "registry", {
  tables: [],
  register(e) {
    G.registry.tables.push(e);
  },
  deregister(e) {
    var t = G.registry.tables.indexOf(e);
    t > -1 && G.registry.tables.splice(t, 1);
  },
  lookupTable(e, t) {
    var i = [], s, n;
    if (typeof e == "string") {
      if (s = document.querySelectorAll(e), s.length)
        for (var r = 0; r < s.length; r++)
          n = G.registry.matchElement(s[r]), n && i.push(n);
    } else typeof HTMLElement < "u" && e instanceof HTMLElement || e instanceof G ? (n = G.registry.matchElement(e), n && i.push(n)) : Array.isArray(e) ? e.forEach(function(o) {
      i = i.concat(G.registry.lookupTable(o));
    }) : t || console.warn("Table Connection Error - Invalid Selector", e);
    return i;
  },
  matchElement(e) {
    return G.registry.tables.find(function(t) {
...
const z = class z extends St {
  ...
  static initializeModuleBinder(e) {
    z.modulesRegistered || (z.modulesRegistered = !0, z._registerModules(Rr, !0), e && z._registerModules(e));
  }
    ...
    if (e.moduleExtensions)
      for (let i in t) {
        ...
        if (z.moduleBindings[i])
          for (let n in s)
            z._extendModule(i, n, s[n]);
        else {
          z.moduleExtensions[i] || (z.moduleExtensions[i] = {});
          for (let n in s)
            z.moduleExtensions[i][n] || (z.moduleExtensions[i][n] = {}), Object.assign(z.moduleExtensions[i][n], s[n]);
        }
      }
  ...
  _bindModules() {
    ...
    for (var s in z.moduleBindings) {
      let n = z.moduleBindings[s], r = new n(this);
...
C(z, "moduleBindings", {}), C(z, "moduleExtensions", {}), C(z, "modulesRegistered", !1), C(z, "defaultModules", !1);
let Dt = z;
class xr extends B {
  constructor(e) {
...
const Q = class Q extends Dt {
  ...
  initializeCoreSystems(e) {
    this.columnManager = new or(this), this.rowManager = new hr(this), this.footerManager = new dr(this), this.dataLoader = new fr(this), this.alertManager = new xr(this), this._bindModules(), this.options = this.optionsList.generate(Q.defaultOptions, e), this._clearObjectPointers(), this._mapDeprecatedFunctionality(), this.externalEvents = new pr(this, this.options, this.options.debugEventsExternal), this.eventBus = new mr(this.options.debugEventsInternal), this.interactionMonitor = new ur(this), this.dataLoader.initialize(), this.footerManager.initialize(), this.dependencyRegistry.initialize();
  }
...
C(Q, "defaultOptions", sr);
let zt = Q;
var Oe = zt;
class Tr extends Oe {
  static extendModule() {
    Oe.initializeModuleBinder(nt), Oe._extendModule(...arguments);
  }
  static registerModule() {
    Oe.initializeModuleBinder(nt), Oe._registerModule(...arguments);
  }
  constructor(e, t, i) {
    super(e, t, nt);
  }
...
var kr = Tr, Gt = class {
  ...
  // file was imported.
  setTimeout: (a, e) => setTimeout(a, e),
  clearTimeout: (a) => clearTimeout(a),
  setInterval: (a, e) => setInterval(a, e),
  ...
  setTimeoutProvider(a) {
    process.env.NODE_ENV !== "production" && b(this, pe) && a !== b(this, K) && console.error(
      "[timeoutManager]: Switching provider after calls to previous provider might result in unexpected behavior.",
      { previous: b(this, K), provider: a }
    ), T(this, K, a), process.env.NODE_ENV !== "production" && T(this, pe, !1);
  }
  setTimeout(a, e) {
    return process.env.NODE_ENV !== "production" && T(this, pe, !0), b(this, K).setTimeout(a, e);
  }
  clearTimeout(a) {
    b(this, K).clearTimeout(a);
  }
  setInterval(a, e) {
    return process.env.NODE_ENV !== "production" && T(this, pe, !0), b(this, K).setInterval(a, e);
  }
  clearInterval(a) {
    b(this, K).clearInterval(a);
  }
}, K = new WeakMap(), pe = new WeakMap(), li), qe = new Lr();
function Sr(a) {
  setTimeout(a, 0);
}
...
function zr(a, e) {
  return Math.max(a + (e || 0) - Date.now(), 0);
}
function Be(a, e) {
...
function Ft(a, e) {
  if (a === e)
    return a;
  const t = Zt(a) && Zt(e);
  if (!t && !(ei(a) && ei(e))) return e;
  const s = (t ? a : Object.keys(a)).length, n = t ? e : Object.keys(e), r = n.length, o = t ? new Array(r) : {};
  let l = 0;
  for (let h = 0; h < r; h++) {
    const d = t ? h : n[h], u = a[d], c = e[d];
    if (u === c) {
      o[d] = u, (t ? h < s : Fr.call(a, d)) && l++;
      continue;
    }
...
function Ht(a, e) {
  if (!e || Object.keys(a).length !== Object.keys(e).length)
    return !1;
  for (const t in a)
    if (a[t] !== e[t])
      return !1;
...
function ei(a) {
  ...
  if (e === void 0)
    return !0;
  const t = e.prototype;
  return !(!ti(t) || !t.hasOwnProperty("isPrototypeOf") || Object.getPrototypeOf(a) !== Object.prototype);
}
function ti(a) {
...
function ii(a, e, t) {
  if (typeof t.structuralSharing == "function")
    return t.structuralSharing(a, e);
...
var me, oe, Me, hi, Hr = (hi = class extends Gt {
  constructor() {
    super();
    O(this, me);
    O(this, oe);
  ...
  onSubscribe() {
    b(this, oe) || this.setEventListener(b(this, Me));
  }
  onUnsubscribe() {
    var e;
    this.hasListeners() || ((e = b(this, oe)) == null || e.call(this), T(this, oe, void 0));
  }
  setEventListener(e) {
    var t;
    T(this, Me, e), (t = b(this, oe)) == null || t.call(this), T(this, oe, e((i) => {
      typeof i == "boolean" ? this.setFocused(i) : this.onFocus();
    }));
  }
  setFocused(e) {
    b(this, me) !== e && (T(this, me, e), this.onFocus());
  }
  onFocus() {
  ...
  isFocused() {
    var e;
    return typeof b(this, me) == "boolean" ? b(this, me) : ((e = globalThis.document) == null ? void 0 : e.visibilityState) !== "hidden";
  }
}, me = new WeakMap(), oe = new WeakMap(), Me = new WeakMap(), hi), Or = new Hr();
function ni() {
  let a, e;
...
var _r = Ar(), Le, ae, Se, di, Br = (di = class extends Gt {
  constructor() {
    super();
    O(this, Le, !0);
    O(this, ae);
  ...
  onSubscribe() {
    b(this, ae) || this.setEventListener(b(this, Se));
  }
  onUnsubscribe() {
    var e;
    this.hasListeners() || ((e = b(this, ae)) == null || e.call(this), T(this, ae, void 0));
  }
  setEventListener(e) {
    var t;
    T(this, Se, e), (t = b(this, ae)) == null || t.call(this), T(this, ae, e(this.setOnline.bind(this)));
  }
  setOnline(e) {
    b(this, Le) !== e && (T(this, Le, e), this.listeners.forEach((i) => {
      i(e);
    }));
  }
  isOnline() {
...
}, Le = new WeakMap(), ae = new WeakMap(), Se = new WeakMap(), di), Ir = new Br();
function Vr(a) {
...
var W, k, Ge, V, ge, De, Z, le, Ue, ze, Fe, be, ve, he, He, D, _e, Ot, Pt, At, _t, Bt, It, Vt, Bi, ui, Wr = (ui = class extends Gt {
  constructor(e, t) {
    super();
    O(this, D);
    O(this, W);
    ...
    O(this, ve);
    O(this, he);
    O(this, He, /* @__PURE__ */ new Set());
    this.options = t, T(this, W, e), T(this, le, null), T(this, Z, ni()), this.bindMethods(), this.setOptions(t);
  }
  bindMethods() {
    this.refetch = this.refetch.bind(this);
  }
  onSubscribe() {
    this.listeners.size === 1 && (b(this, k).addObserver(this), ri(b(this, k), this.options) ? A(this, D, _e).call(this) : this.updateResult(), A(this, D, _t).call(this));
  }
  onUnsubscribe() {
  ...
  destroy() {
    this.listeners = /* @__PURE__ */ new Set(), A(this, D, Bt).call(this), A(this, D, It).call(this), b(this, k).removeObserver(this);
  }
  setOptions(e) {
    const t = this.options, i = b(this, k);
    if (this.options = b(this, W).defaultQueryOptions(e), this.options.enabled !== void 0 && typeof this.options.enabled != "boolean" && typeof this.options.enabled != "function" && typeof J(this.options.enabled, b(this, k)) != "boolean")
      throw new Error(
        "Expected enabled to be a boolean or a callback that returns a boolean"
      );
    A(this, D, Vt).call(this), b(this, k).setOptions(this.options), t._defaulted && !Ht(this.options, t) && b(this, W).getQueryCache().notify({
    ...
    s && oi(
      ...
      this.options,
      t
    ) && A(this, D, _e).call(this), this.updateResult(), s && (b(this, k) !== i || J(this.options.enabled, b(this, k)) !== J(t.enabled, b(this, k)) || Be(this.options.staleTime, b(this, k)) !== Be(t.staleTime, b(this, k))) && A(this, D, Ot).call(this);
    const n = A(this, D, Pt).call(this);
    s && (b(this, k) !== i || J(this.options.enabled, b(this, k)) !== J(t.enabled, b(this, k)) || n !== b(this, he)) && A(this, D, At).call(this, n);
  }
  getOptimisticResult(e) {
    const t = b(this, W).getQueryCache().build(b(this, W), e), i = this.createResult(t, e);
    return Gr(this, i) && (T(this, V, i), T(this, De, this.options), T(this, ge, b(this, k).state)), i;
  }
  getCurrentResult() {
    return b(this, V);
  }
  trackResult(e, t) {
    return new Proxy(e, {
      get: (i, s) => (this.trackProp(s), t == null || t(s), s === "promise" && (this.trackProp("data"), !this.options.experimental_prefetchInRender && b(this, Z).status === "pending" && b(this, Z).reject(
        new Error(
  ...
  fetchOptimistic(e) {
    const t = b(this, W).defaultQueryOptions(e), i = b(this, W).getQueryCache().build(b(this, W), t);
    return i.fetch().then(() => this.createResult(i, t));
  }
  fetch(e) {
    return A(this, D, _e).call(this, {
      ...e,
      cancelRefetch: e.cancelRefetch ?? !0
    }).then(() => (this.updateResult(), b(this, V)));
  }
  createResult(e, t) {
    var P;
    const i = b(this, k), s = this.options, n = b(this, V), r = b(this, ge), o = b(this, De), h = e !== i ? e.state : b(this, Ge), { state: d } = e;
    let u = { ...d }, c = !1, f;
    if (t._optimisticResults) {
      const M = this.hasListeners(), U = !M && ri(e, t), x = M && oi(e, i, t, s);
      (U || x) && (u = {
        ...u,
        ...Nr(d.data, e.options)
      }), t._optimisticResults === "isRestoring" && (u.fetchStatus = "idle");
    }
    let { error: p, errorUpdatedAt: m, status: v } = u;
    f = u.data;
    let g = !1;
    if (t.placeholderData !== void 0 && f === void 0 && v === "pending") {
      let M;
      n != null && n.isPlaceholderData && t.placeholderData === (o == null ? void 0 : o.placeholderData) ? (M = n.data, g = !0) : M = typeof t.placeholderData == "function" ? t.placeholderData(
        (P = b(this, Fe)) == null ? void 0 : P.state.data,
        b(this, Fe)
      ) : t.placeholderData, M !== void 0 && (v = "success", f = ii(
    ...
    if (t.select && f !== void 0 && !g)
      if (n && f === (r == null ? void 0 : r.data) && t.select === b(this, Ue))
        f = b(this, ze);
      else
        try {
          T(this, Ue, t.select), f = t.select(f), f = ii(n == null ? void 0 : n.data, f, t), T(this, ze, f), T(this, le, null);
        } catch (M) {
          T(this, le, M);
        }
    b(this, le) && (p = b(this, le), f = b(this, ze), m = Date.now(), v = "error");
    const E = u.fetchStatus === "fetching", L = v === "pending", H = v === "error", S = L && E, _ = f !== void 0, w = {
      status: v,
    ...
    if (this.options.experimental_prefetchInRender) {
      const M = (de) => {
        w.status === "error" ? de.reject(w.error) : w.data !== void 0 && de.resolve(w.data);
      }, U = () => {
        const de = T(this, Z, w.promise = ni());
        M(de);
      }, x = b(this, Z);
      switch (x.status) {
        case "pending":
          e.queryHash === i.queryHash && M(x);
          break;
        case "fulfilled":
          (w.status === "error" || w.data !== x.value) && U();
          break;
        case "rejected":
          (w.status !== "error" || w.error !== x.reason) && U();
          break;
      }
    }
    return w;
  ...
  updateResult() {
    const e = b(this, V), t = this.createResult(b(this, k), this.options);
    if (T(this, ge, b(this, k).state), T(this, De, this.options), b(this, ge).data !== void 0 && T(this, Fe, b(this, k)), Ht(t, e))
      return;
    T(this, V, t);
    const i = () => {
      if (!e)
      ...
      if (n === "all" || !n && !b(this, He).size)
        return !0;
      const r = new Set(
        n ?? b(this, He)
      );
      return this.options.throwOnError && r.add("error"), Object.keys(b(this, V)).some((o) => {
        const l = o;
        return b(this, V)[l] !== e[l] && r.has(l);
      });
    };
    A(this, D, Bi).call(this, { listeners: i() });
  }
  onQueryUpdate() {
    this.updateResult(), this.hasListeners() && A(this, D, _t).call(this);
  }
}, W = new WeakMap(), k = new WeakMap(), Ge = new WeakMap(), V = new WeakMap(), ge = new WeakMap(), De = new WeakMap(), Z = new WeakMap(), le = new WeakMap(), Ue = new WeakMap(), ze = new WeakMap(), Fe = new WeakMap(), be = new WeakMap(), ve = new WeakMap(), he = new WeakMap(), He = new WeakMap(), D = new WeakSet(), _e = function(e) {
  A(this, D, Vt).call(this);
  let t = b(this, k).fetch(
    this.options,
    e
  );
  return e != null && e.throwOnError || (t = t.catch(Dr)), t;
}, Ot = function() {
  A(this, D, Bt).call(this);
  const e = Be(
    this.options.staleTime,
    b(this, k)
  );
  if (Ye || b(this, V).isStale || !Qt(e))
    return;
  const i = zr(b(this, V).dataUpdatedAt, e) + 1;
  T(this, be, qe.setTimeout(() => {
    b(this, V).isStale || this.updateResult();
  }, i));
}, Pt = function() {
  return (typeof this.options.refetchInterval == "function" ? this.options.refetchInterval(b(this, k)) : this.options.refetchInterval) ?? !1;
}, At = function(e) {
  A(this, D, It).call(this), T(this, he, e), !(Ye || J(this.options.enabled, b(this, k)) === !1 || !Qt(b(this, he)) || b(this, he) === 0) && T(this, ve, qe.setInterval(() => {
    (this.options.refetchIntervalInBackground || Or.isFocused()) && A(this, D, _e).call(this);
  }, b(this, he)));
}, _t = function() {
  A(this, D, Ot).call(this), A(this, D, At).call(this, A(this, D, Pt).call(this));
}, Bt = function() {
  b(this, be) && (qe.clearTimeout(b(this, be)), T(this, be, void 0));
}, It = function() {
  b(this, ve) && (qe.clearInterval(b(this, ve)), T(this, ve, void 0));
}, Vt = function() {
  const e = b(this, W).getQueryCache().build(b(this, W), this.options);
  if (e === b(this, k))
    return;
  const t = b(this, k);
  T(this, k, e), T(this, Ge, e.state), this.hasListeners() && (t == null || t.removeObserver(this), e.addObserver(this));
}, Bi = function(e) {
  _r.batch(() => {
    e.listeners && this.listeners.forEach((t) => {
      t(b(this, V));
    }), b(this, W).getQueryCache().notify({
      query: b(this, k),
...
function jr(a, e) {
  return J(e.enabled, a) !== !1 && a.state.data === void 0 && !(a.state.status === "error" && e.retryOnMount === !1);
}
function ri(a, e) {
  return jr(a, e) || a.state.data !== void 0 && Nt(a, e, e.refetchOnMount);
}
function Nt(a, e, t) {
  if (J(e.enabled, a) !== !1 && Be(e.staleTime, a) !== "static") {
    const i = typeof t == "function" ? t(a) : t;
    return i === "always" || i !== !1 && Ut(a, e);
  }
  return !1;
}
function oi(a, e, t, i) {
  return (a !== e || J(i.enabled, a) === !1) && (!t.suspense || a.state.status !== "error") && Ut(a, t);
}
function Ut(a, e) {
  return J(e.enabled, a) !== !1 && a.isStaleByTime(Be(e.staleTime, a));
}
function Gr(a, e) {
  return !Ht(a.getCurrentResult(), e);
}
var Ur = "VUE_QUERY_CLIENT";
function Xr(a) {
  const e = a ? `:${a}` : "";
  return `${Ur}${e}`;
}
...
function Wt(a, e, t = "", i = 0) {
  if (e) {
    const s = e(a, t, i);
    if (s === void 0 && ci(a) || s !== void 0)
      return s;
  }
  if (Array.isArray(a))
    return a.map(
      (s, n) => Wt(s, e, String(n), i + 1)
    );
  if (typeof a == "object" && qr(a)) {
    const s = Object.entries(a).map(([n, r]) => [
      n,
      Wt(r, e, n, i + 1)
    ]);
...
function $r(a, e, t) {
  process.env.NODE_ENV === "development" && (ji() || console.warn(
  ...
  }), n = new a(i, s.value), r = s.value.shallow ? Gi(n.getCurrentResult()) : Ui(n.getCurrentResult());
  let o = () => {
  };
  i.isRestoring && ye(
    i.isRestoring,
  ...
  const l = () => {
    n.setOptions(s.value), ai(r, n.getCurrentResult());
  };
  ye(s, l), Xi(() => {
    o();
  });
  const h = (...f) => (l(), r.refetch(...f)), d = () => new Promise(
    (f, p) => {
      let m = () => {
      };
      const v = () => {
        if (s.value.enabled !== !1) {
          ...
          g.isStale ? (m(), n.fetchOptimistic(s.value).then(f, (E) => {
            si(s.value.throwOnError, [
              E,
              n.getCurrentQuery()
            ]) ? p(E) : f(n.getCurrentResult());
          })) : (m(), f(g));
        }
      };
      v(), m = ye(s, v);
  ...
  ye(
    () => r.error,
    (f) => {
      if (r.isError && !r.isFetching && si(s.value.throwOnError, [
        f,
        n.getCurrentQuery()
      ]))
        throw f;
  ...
  const u = s.value.shallow ? Ji(r) : qi(r), c = Ki(u);
  for (const f in r)
    typeof r[f] == "function" && (c[f] = r[f]);
  return c.suspense = d, c.refetch = h, c;
}
function Yr(a, e) {
  return $r(Wr, a);
}
const Qr = Symbol.for("y2kfund.supabase"), Zr = {
...
function io(a, e) {
  const t = eo(), i = Zr.trades(a), s = Ii(), n = Yr({
    queryKey: i,
    queryFn: async () => {
      var o, l;
      const h = await to(t, e);
      ...
      console.log("✅ Trades query success:", {
        latestFetchedAt: u,
        tradesCount: (o = f.data) == null ? void 0 : o.length,
        accountsCount: (l = p.data) == null ? void 0 : l.length,
        filtered: h.length > 0,
        accessibleAccounts: h.length > 0 ? h : "all"
      });
      const m = new Map(
        (p.data || []).map((v) => [v.internal_account_id, v.legal_entity])
      );
      return (f.data || []).map((v) => ({
        ...v,
        legal_entity: m.get(v.internal_account_id) || void 0
      }));
    },
    staleTime: 6e4
  }), r = t.channel(`trades:${a}`).on(
    "postgres_changes",
    {
      schema: "hf",
      table: "trades",
  ...
  return {
    ...
    _cleanup: () => {
      var o;
      (o = r == null ? void 0 : r.unsubscribe) == null || o.call(r);
    }
  };
}
const so = { class: "trades-card" }, no = { class: "toast-container" }, ro = { key: 0 }, oo = ["onClick"], ao = {
  key: 0,
  class: "loading"
}, lo = {
  key: 1,
...
}, uo = { class: "trades-header" }, co = { key: 1 }, fo = { class: "trades-tools" }, po = { class: "trades-count" }, mo = { class: "commission-total" }, go = { class: "net-quantity" }, bo = /* @__PURE__ */ $i({
  __name: "Trades",
  props: {
    accountId: { default: "1" },
  ...
  setup(a, { emit: e }) {
    const t = a, i = e, s = io(t.accountId, t.userId), n = Je(null);
    let r = null;
    const o = Je(!1), l = Je(!1), h = Je([]);
    let d = 0;
    function u(y, w, P) {
      const M = d++;
      h.value.push({ id: M, type: y, title: w, message: P }), setTimeout(() => c(M), 5e3);
    }
    function c(y) {
      const w = h.value.findIndex((P) => P.id === y);
      w !== -1 && h.value.splice(w, 1);
    }
    function f(y) {
      if (!y)
        return "⏱️ Last Updated: Not available";
      try {
        const w = new Date(y), P = Intl.DateTimeFormat().resolvedOptions().timeZone, U = {
          "Asia/Kolkata": "IST",
          "Asia/Calcutta": "IST",
          "America/New_York": w.getMonth() >= 2 && w.getMonth() < 10 ? "EDT" : "EST",
          "America/Los_Angeles": w.getMonth() >= 2 && w.getMonth() < 10 ? "PDT" : "PST",
          "America/Chicago": w.getMonth() >= 2 && w.getMonth() < 10 ? "CDT" : "CST",
          "America/Denver": w.getMonth() >= 2 && w.getMonth() < 10 ? "MDT" : "MST",
          "Europe/London": w.getMonth() >= 2 && w.getMonth() < 9 ? "BST" : "GMT",
          "Europe/Paris": w.getMonth() >= 2 && w.getMonth() < 9 ? "CEST" : "CET",
          "Australia/Sydney": w.getMonth() >= 9 || w.getMonth() < 3 ? "AEDT" : "AEST"
        }[P] || P, x = w.toLocaleDateString("en-US", {
          month: "short",
          day: "numeric",
          year: "numeric",
          timeZone: P
        }), de = w.toLocaleTimeString("en-US", {
          hour: "2-digit",
          minute: "2-digit",
          second: "2-digit",
          hour12: !0,
        ...
        return `⏱️ Last Updated: ${x} at ${de} ${U}`;
      } catch {
    ...
    function p() {
      return [
        ...
        },
        {
          ...
          action: (y, w) => {
            const M = w.getData().fetched_at;
            M ? navigator.clipboard.writeText(M).then(() => {
              u("success", "Copied!", "Timestamp copied to clipboard");
            }).catch((U) => {
              console.error("Failed to copy:", U), u("error", "Copy Failed", "Could not copy timestamp");
            }) : u("warning", "No Data", "No timestamp available to copy");
          }
        }
      ];
    }
    ...
    const g = Ae(() => {
      var y;
      return ((y = s.data.value) == null ? void 0 : y.length) || 0;
    }), E = Ae(() => s.data.value ? s.data.value.reduce((y, w) => y + (parseFloat(w.ibCommission) || 0), 0) : 0), L = Ae(() => s.data.value ? s.data.value.reduce((y, w) => {
      const P = parseFloat(w.quantity) || 0;
      return y + (w.buySell === "BUY" ? P : -P);
    }, 0) : 0), H = Ae(() => [
      {
        title: "Account",
        field: "legal_entity",
        ...
        formatter: (y) => {
          const w = y.getValue();
          return w ? `<span style="font-weight: 500;">${w}</span>` : '<span style="color: #6c757d; font-style: italic;">N/A</span>';
        },
        contextMenu: p()
      },
      {
        ...
        frozen: !0,
        sorter: "string",
        formatter: (y) => `<span style="font-weight: 600; color: #007bff;">${y.getValue()}</span>`,
        contextMenu: p()
      },
      {
        title: "Side",
      ...
      },
      {
        ...
        hozAlign: "right",
        sorter: "number",
        formatter: (y) => v(parseFloat(y.getValue()) || 0),
        bottomCalc: "sum",
        bottomCalcFormatter: (y) => v(y.getValue()),
        contextMenu: p()
      },
      {
        title: "Price",
        ...
        hozAlign: "right",
        sorter: "number",
        formatter: (y) => m(parseFloat(y.getValue()) || 0),
        contextMenu: p()
      },
      {
        title: "Asset Class",
      ...
      },
      {
        ...
        minWidth: 120,
        sorter: "date",
        formatter: (y) => y.getValue() ? new Date(y.getValue()).toLocaleDateString() : "",
        contextMenu: p()
      },
      {
      ...
      },
      {
        ...
        formatter: (y) => `<span style="font-weight: 600;">${m(parseFloat(y.getValue()) || 0)}</span>`,
        bottomCalc: "sum",
        bottomCalcFormatter: (y) => m(y.getValue() || 0),
        contextMenu: p()
      },
      {
        title: "Commission",
        ...
        hozAlign: "right",
        sorter: "number",
        formatter: (y) => `<span style="color: #dc3545; font-weight: 600;">${m(parseFloat(y.getValue()) || 0)}</span>`,
        bottomCalc: "sum",
        bottomCalcFormatter: (y) => m(y.getValue()),
        contextMenu: p()
      }
    ]);
    function S() {
      ...
      try {
        r = new kr(n.value, y), r.on("tableBuilt", function() {
          o.value = !0;
        });
      } catch (w) {
    ...
    ye([() => s.isSuccess.value, n], async ([y, w]) => {
      y && w && !l.value && (await Yi(), S(), l.value = !0);
    }, { immediate: !0 }), ye(() => s.data.value, async (y) => {
      if (!(!r || !y))
        try {
          r.replaceData(y);
        } catch (w) {
    ...
    return Qi(() => {
      ...
      if (r)
        try {
          ...
          console.warn("Error destroying tabulator:", w);
        }
      (y = s._cleanup) == null || y.call(s);
    }), (y, w) => {
      const P = Zi("router-link");
      return q(), $("div", so, [
        j("div", no, [
          (q(!0), $(es, null, ts(h.value, (M) => (q(), $("div", {
            key: M.id,
            class: is(["toast", `toast-${M.type}`])
          }, [
            j("strong", null, Ce(M.title), 1),
            M.message ? (q(), $("span", ro, Ce(M.message), 1)) : it("", !0),
            j("button", {
              onClick: (U) => c(M.id),
              class: "toast-close"
            }, "×", 8, oo)
        ...
        Pe(s).isLoading.value ? (q(), $("div", ao, [...w[0] || (w[0] = [
          j("div", { class: "loading-spinner" }, null, -1),
          qt(" Loading trades... ", -1)
        ])])) : Pe(s).isError.value ? (q(), $("div", lo, [
          w[1] || (w[1] = j("h3", null, "Error loading trades", -1)),
          j("p", null, Ce(Pe(s).error.value), 1)
        ])) : Pe(s).isSuccess.value ? (q(), $("div", ho, [
          j("div", uo, [
            j("h2", null, [
              a.showHeaderLink ? (q(), ss(P, {
                key: 0,
                to: "/trades"
              }, {
                default: ns(() => [...w[2] || (w[2] = [
            ...
            j("div", fo, [
              j("div", po, Ce(g.value) + " trades", 1),
              j("div", mo, "Commission: " + Ce(m(E.value)), 1),
              j("div", go, "Net Qty: " + Ce(v(L.value)), 1),
              a.showHeaderLink ? (q(), $("button", {
                key: 0,
                onClick: _,
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Eo = /* @__PURE__ */ vo(bo, [["__scopeId", "data-v-3480913e"]]);
export {
  Eo as Trades,
  Eo as default
};
