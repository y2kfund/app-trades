...
var w = (a, e, t) => Ni(a, typeof e != "symbol" ? e + "" : e, t), tt = (a, e, t) => e.has(a) || Jt("Cannot " + t);
...
w(Re, "moduleName", "accessor"), //load defaults
w(Re, "accessors", os);
let rt = Re;
var as = {
  method: "GET"
...
w(X, "moduleName", "ajax"), //load defaults
w(X, "defaultConfig", as), w(X, "defaultURLGenerator", mi), w(X, "defaultLoaderPromise", hs), w(X, "contentTypeFormatters", ds);
let lt = X;
var us = {
  replace: function(a) {
...
w(ee, "moduleName", "clipboard"), w(ee, "moduleExtensions", ms), //load defaults
w(ee, "pasteActions", us), w(ee, "pasteParsers", cs);
let ht = ee;
class gs {
  constructor(e) {
...
w(te, "moduleName", "columnCalcs"), //load defaults
w(te, "calculations", bs);
let dt = te;
class wi extends R {
  constructor(e) {
...
w(xe, "moduleName", "download"), //load defaults
w(xe, "downloaders", xs);
let ut = xe;
function Ze(a, e) {
...
w(Ie, "moduleName", "edit"), //load defaults
w(Ie, "editors", Bs);
let ct = Ie;
class Kt {
  constructor(e, t, i, s) {
...
w(ie, "moduleName", "export"), w(ie, "columnLookups", Is), w(ie, "rowLookups", Vs);
let ft = ie;
var Ns = {
  //equal to
  "=": function(a, e, t, i) {
...
w(Y, "moduleName", "filter"), //load defaults
w(Y, "filters", Ns);
let pt = Y;
function Ws(a, e, t) {
...
w(se, "moduleName", "format"), //load defaults
w(se, "formatters", un);
let mt = se;
class Ci extends R {
  constructor(e) {
...
w(ne, "moduleName", "history"), w(ne, "moduleExtensions", bn), //load defaults
w(ne, "undoers", fn), w(ne, "redoers", pn);
let gt = ne;
class Ri extends R {
  constructor(e) {
...
w(Ri, "moduleName", "htmlTableImport");
function vn(a) {
  var e = [], t = 0, i = 0, s = !1;
...
w(Ve, "moduleName", "import"), //load defaults
w(Ve, "importers", En);
let bt = Ve;
class xi extends R {
  constructor(e) {
...
w(re, "moduleName", "keybindings"), //load defaults
w(re, "bindings", Rn), w(re, "actions", xn);
let vt = re;
class Ti extends R {
  constructor(e) {
...
w(ce, "moduleName", "moveRow"), //load defaults
w(ce, "senders", Tn), w(ce, "receivers", kn);
let wt = ce;
var Mn = {};
const Te = class Te extends R {
  constructor(e) {
...
w(Te, "moduleName", "mutator"), //load defaults
w(Te, "mutators", Mn);
let Ct = Te;
...
w(Ne, "moduleName", "page"), //load defaults
w(Ne, "pageCounters", Dn);
let yt = Ne;
var zn = {
  local: function(a, e) {
...
w(N, "moduleName", "persistence"), w(N, "moduleInitOrder", -10), //load defaults
w(N, "readers", zn), w(N, "writers", Fn);
let Et = N;
class Mi extends R {
  constructor(e) {
...
w(Rt, "moduleName", "responsiveLayout"), w(Rt, "moduleExtensions", On);
function Pn(a, e, t) {
...
w(xt, "moduleName", "selectRow"), w(xt, "moduleExtensions", An);
class _n {
  constructor(e) {
...
w(Ke, "moduleName", "selectRange"), w(Ke, "moduleInitOrder", 1), w(Ke, "moduleExtensions", Un);
...
w(fe, "moduleName", "sort"), //load defaults
w(fe, "sorters", er);
let Tt = fe;
class tr {
  constructor(e, t) {
...
w(We, "moduleName", "validate"), //load defaults
w(We, "validators", ir);
let kt = We;
  ...
  _virtualRenderFill(e, t, i) {
    ...
    if (f && F.elVisible(this.elementVertical)) {
      for (this.vDomTop = e, this.vDomBottom = e - 1, H || this.table.options.maxHeight ? (_ && (L = S / _ + this.vDomWindowBuffer / _), L = Math.max(this.vDomWindowMinTotalRows, Math.ceil(L))) : L = f; (L == f || o <= S + this.vDomWindowBuffer || E < this.vDomWindowMinTotalRows) && this.vDomBottom < f - 1; ) {
        ...
        if (!g.length)
          break;
        s.appendChild(v), g.forEach((C) => {
          C.rendered(), C.heightInitialized || C.calcHeight(!0);
        }), g.forEach((C) => {
          C.heightInitialized || C.setCellHeight();
        }), g.forEach((C) => {
          l = C.getHeight(), E < r ? d += l : o += l, l > this.vDomWindowBuffer && (this.vDomWindowBuffer = l * 2), E++;
...
function Cr(a, e) {
  ...
  function f(p, m, v, g) {
    var E = [], L = 0, H = 0, S = 0, _ = n, y = 0, C = 0, P = [];
    function M(x) {
    ...
    return p.forEach(function(x, de) {
      var Xt = g ? U(x) : M(x);
      x.column.minWidth >= Xt ? E.push(x) : x.column.maxWidth && x.column.maxWidth < Xt ? (x.width = x.column.maxWidth, m -= x.column.maxWidth, _ -= g ? x.column.definition.widthShrink || 1 : x.column.definition.widthGrow || 1, _ && (v = Math.floor(m / _))) : (P.push(x), C += g ? x.column.definition.widthShrink || 1 : x.column.definition.widthGrow || 1);
    }), E.length ? (E.forEach(function(x) {
      L += g ? x.width - x.column.minWidth : x.column.minWidth, x.width = x.column.minWidth;
    }), H = m - L, S = C ? Math.floor(H / C) : H, y = f(P, H, S, g)) : (y = C ? m - Math.floor(m / C) * C : m, P.forEach(function(x) {
      x.width = g ? U(x) : M(x);
    })), y;
  }
...
w(ke, "moduleName", "layout"), //load defaults
w(ke, "modes", yr);
let Mt = ke;
var Er = {
  default: {
...
w(je, "moduleName", "localize"), //load defaults
w(je, "langs", Er);
let Lt = je;
class _i extends R {
  constructor(e) {
...
w(z, "moduleBindings", {}), w(z, "moduleExtensions", {}), w(z, "modulesRegistered", !1), w(z, "defaultModules", !1);
let Dt = z;
class xr extends B {
  constructor(e) {
...
var W, k, Ge, V, ge, De, Z, le, Ue, ze, Fe, be, ve, he, He, D, _e, Ot, Pt, At, _t, Bt, It, Vt, Bi, ui, Wr = (ui = class extends Gt {
  ...
  createResult(e, t) {
    ...
    const E = u.fetchStatus === "fetching", L = v === "pending", H = v === "error", S = L && E, _ = f !== void 0, C = {
      status: v,
    ...
    if (this.options.experimental_prefetchInRender) {
      const M = (de) => {
        C.status === "error" ? de.reject(C.error) : C.data !== void 0 && de.resolve(C.data);
      }, U = () => {
        const de = T(this, Z, C.promise = ni());
        M(de);
      }, x = b(this, Z);
      switch (x.status) {
        case "pending":
...
const so = { class: "trades-card" }, no = { class: "toast-container" }, ro = { key: 0 }, oo = ["onClick"], ao = {
  ...
  setup(a, { emit: e }) {
    ...
    function u(y, C, P) {
      const M = d++;
      h.value.push({ id: M, type: y, title: C, message: P }), setTimeout(() => c(M), 5e3);
    }
    function c(y) {
      const C = h.value.findIndex((P) => P.id === y);
      C !== -1 && h.value.splice(C, 1);
    }
    function f(y) {
      if (!y)
        return "⏱️ Last Updated: Not available";
      try {
        const C = new Date(y), P = Intl.DateTimeFormat().resolvedOptions().timeZone, U = {
          "Asia/Kolkata": "IST",
          "Asia/Calcutta": "IST",
          "America/New_York": C.getMonth() >= 2 && C.getMonth() < 10 ? "EDT" : "EST",
          "America/Los_Angeles": C.getMonth() >= 2 && C.getMonth() < 10 ? "PDT" : "PST",
          "America/Chicago": C.getMonth() >= 2 && C.getMonth() < 10 ? "CDT" : "CST",
          "America/Denver": C.getMonth() >= 2 && C.getMonth() < 10 ? "MDT" : "MST",
          "Europe/London": C.getMonth() >= 2 && C.getMonth() < 9 ? "BST" : "GMT",
          "Europe/Paris": C.getMonth() >= 2 && C.getMonth() < 9 ? "CEST" : "CET",
          "Australia/Sydney": C.getMonth() >= 9 || C.getMonth() < 3 ? "AEDT" : "AEST"
        }[P] || P, x = C.toLocaleDateString("en-US", {
          month: "short",
          day: "numeric",
          year: "numeric",
          timeZone: P
        }), de = C.toLocaleTimeString("en-US", {
          hour: "2-digit",
          minute: "2-digit",
          second: "2-digit",
          hour12: !0,
    ...
    }), E = Ae(() => s.data.value ? s.data.value.reduce((y, C) => y + (parseFloat(C.ibCommission) || 0), 0) : 0), L = Ae(() => s.data.value ? s.data.value.reduce((y, C) => {
      const P = parseFloat(C.quantity) || 0;
      return y + (C.buySell === "BUY" ? P : -P);
    }, 0) : 0), H = Ae(() => [
      {
        title: "Account",
        field: "legal_entity",
        ...
        formatter: (y) => {
          const C = y.getValue();
          return C ? `<span style="font-weight: 500;">${C}</span>` : '<span style="color: #6c757d; font-style: italic;">N/A</span>';
        },
        contextMenu: p()
      },
      {
    ...
    ye([() => s.isSuccess.value, n], async ([y, C]) => {
      y && C && !l.value && (await Yi(), S(), l.value = !0);
    }, { immediate: !0 }), ye(() => s.data.value, async (y) => {
      if (!(!r || !y))
        try {
          r.replaceData(y);
        } catch (C) {
          console.warn("Error updating table data:", C);
        }
    }, { deep: !0 });
    function _() {
      i("minimize");
    ...
    return Qi(() => {
      ...
      return q(), $("div", so, [
        ...
        Pe(s).isLoading.value ? (q(), $("div", ao, [...C[0] || (C[0] = [
          j("div", { class: "loading-spinner" }, null, -1),
          qt(" Loading trades... ", -1)
        ])])) : Pe(s).isError.value ? (q(), $("div", lo, [
          C[1] || (C[1] = j("h3", null, "Error loading trades", -1)),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Eo = /* @__PURE__ */ vo(bo, [["__scopeId", "data-v-147cc6f6"]]);
export {
  Eo as Trades,
  Eo as default
};
